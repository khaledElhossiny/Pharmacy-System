...
<br>
    <div style="text-align: center">
        <fieldset>
    <div style="text-align: center">
        <label><h4 style="text-align: center;">Register</h4></label><br>
            <label><h4 style="color: red">Sorry there was an error</h4></label><br>
            <form action="../Controller/UserController.php" method="post">
                ...
                <label for="male">Male</label> <input type = "radio" name = "gender" id = "male" value = "male" required><br>
                        <label for="female">Female</label> <input type="radio" name="gender" id="female"value="female" required ><br>
